package com.ssd.assignmentws.constant;
...
public class ApplicationAssignmentConstant {
	...
	public static final String USER_ASSIGNMENT_IDENTIFIER_KEY = "MY_TEST_USER";
	public static final String APPLICATION_ASSIGNMENT_NAME = "SSD OAuth Spring App";
